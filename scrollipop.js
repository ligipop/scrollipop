		 	...
		 	//Event handler for navigation button scroll animation
		   	function addClickHandler(navButtons){
		    	navButtons.addEventListener("click", function(e){
		    		...
		    		var targetPageTop;
		    		if (vOrH()){
			    		currentPageTop = window.pageYOffset;
			    		targetPageTop = targetPage.offsetTop;
		    		}else if (!vOrH()){
		    			currentPageTop = window.pageXOffset;
			    		targetPageTop = targetPage.offsetLeft;
		    		}
	 		...
	 		if(vOrH()){	
	     		...
	     		el.style.height = 100 + "%";
		  		...
		  		//Create a class attribute and attribute name of 'page_i' for each 'pages' array element
			     	...
			     	pages[i].style.fontSize = 16+"px";
			     	pages[i].style.verticalAlign = "top";
	     	}
